(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@fingerprintjs/fingerprintjs'), require('crypto-es'), require('js-cookie')) :
    typeof define === 'function' && define.amd ? define(['@fingerprintjs/fingerprintjs', 'crypto-es', 'js-cookie'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SecureStorage = factory(global.FingerprintJS, global.CryptoES, global.Cookies));
})(this, (function (FingerprintJS, CryptoES, Cookies) { 'use strict';
